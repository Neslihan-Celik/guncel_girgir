...
(176, '', 'dimg/user.png', '2021-04-30 15:50:34', '', 'Neslihan', 'ÇELİK', 'nescelik96@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '1', 1, 'kadın');
...
--
ALTER TABLE `ilce`
  ADD CONSTRAINT `il_id` FOREIGN KEY (`il_id`) REFERENCES `il` (`il_id`);
COMMIT;
